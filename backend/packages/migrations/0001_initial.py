    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', models.ManyToManyField(blank=True, related_name='packages', to='categories.category')),
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='location.location')),
                ('subcategories', models.ManyToManyField(blank=True, related_name='packages', to='categories.subcategory')),
                ('sublocations', models.ManyToManyField(blank=True, related_name='packages', to='location.sublocation')),
            ],
        ),
    ]
